...
public class CryptoCurrencyResponseAdaptorTest {
    ...
    public void shouldConvertCryptoCurrencyExchangeResponseToExchangeRate(){
        ...
        CryptoCurrencyExchangeResponse currencyExchangeResponse=CryptoCurrencyExchangeResponse.builder().timestamp(Long.parseLong("1658060166"))
        ...
        Assert.assertTrue(exchangerate.getRate()==10000000.00);
    }
}
